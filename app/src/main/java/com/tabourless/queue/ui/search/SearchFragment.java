    ...
    private void showPlaceInfo(Place place) {
        ...
        for (Object o : place.getQueues().entrySet()) {
            ...
            if(null != queue){
                ...
                UserQueue userQueue = new UserQueue(queue.getKey(), queue.getName(), place.getKey(), place.getName(), CUSTOMER_STATUS_WAITING, queue.getCounters());
        ...
        mViewModel.getUserOnce(mCurrentUserId, new FirebaseUserCallback() {
            ...
            public void onCallback(User user) {
                if(user != null){
                    ...
                    Map<String, Boolean> suitableCounters = isMatchedCountersExist(selectedQueue.getCounters() , customer);
